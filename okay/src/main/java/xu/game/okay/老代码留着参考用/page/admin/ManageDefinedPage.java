package xu.game.okay.老代码留着参考用.page.admin;
...
//            if (number > 0) {
//                instance.update("delete from biao2 where guan = " + admin_guan);
//                instance.update("INSERT INTO biao2 (tuxing,shuxing,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10 ) " +
//                        "select tuxing,shuxing,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10 from biao4;");
//                instance.update("update biao2 set guan = " + admin_guan + " where guan is null");
//                instance.update("delete from biao4 where number >0;");
//                instance.update("ALTER TABLE biao4 AUTO_INCREMENT= 1;");
//                number = 0;
//                pan = false;
