...
public class ConfirmActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Map<String, Object> query = jdbc.query("SELECT COUNT(1) FROM user WHERE name = '%s'", userContent);
        ...
        query = jdbc.query("SELECT COUNT(1) FROM user WHERE name != 'admin'");
        ...
        if (count < 18) {
            ...
            jdbc.update("INSERT INTO user (`name`, `pwd`) VALUES('%s', '%s')", userContent, pwdContent);
