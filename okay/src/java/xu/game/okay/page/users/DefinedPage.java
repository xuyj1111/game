        ...
        ok.addActionListener(e -> {
            if (number > 0) {
                ...
                while (true) {
                    String string;
                    nguan++;
                    string = Jdbc.query("select nguan from biao3 where name = '" + username
                            + "' AND nguan = " + nguan + ";");
                    if (string == null)
                        break;
                }
                if (nguan <= 20) {
                    Jdbc.update("INSERT INTO biao3 (tuxing,shuxing,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10 ) " +
                            "select tuxing,shuxing,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,y1,y2,y3,y4,y5,y6,y7,y8,y9,y10 from biao4;");
                    Jdbc.update("update biao3 set name = '" + username + "' where name is null");
                    Jdbc.update("update biao3 set nguan = " + nguan + " where nguan is null");
                }
